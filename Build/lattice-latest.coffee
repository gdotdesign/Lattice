...
define ["Groups.Abstract","Interfaces.Enabled","Interfaces.Size"], "Groups.Toggles", ->
  new Class
...
define ["Core.Abstract","Interfaces.Children"], "Groups.Abstract", ->
  new Class
    ...
    removeItem: (el) ->
      @removeChild el
define ["Groups.Abstract","Interfaces.Controls","Interfaces.Enabled"], "Groups.Icons", ->
  new Class
    Extends: Groups.Abstract
    Implements: [
      Interfaces.Controls
...
define ["Groups.Abstract","Interfaces.Size"], "Groups.Lists", ->
  new Class
    Extends: Groups.Abstract
    Implements: [
      Interfaces.Size
    ...
    mux: ->
      new Hash(@).each (value,key) ->
        if key.test(/^_\$/) and typeOf(value) is "function"
          value.attempt null, @
      , @
define null, "Interfaces.Children", ->
  new Class
    _$Children: ->
      @children = []
    hasChild: (child) ->
...
define "!Drag.Move", "Drag.Ghost", ->
  new Class
	  ...
	  deghost: ->
		  ...
		  @element.destroy();
		  @element = e;
define ["Drag.Float","Drag.Ghost"], "Interfaces.Draggable", ->
  new Class
	  Implements: Options
	  options:
		  draggable: off
...
define null, "Interfaces.Controls", -> 
  new Class
    ...
    toggle: ->
      if @enabled
        @base.toggle()
define ["Core.Abstract","Interfaces.Children","Interfaces.Size"], "Iterable.List", ->
  new Class
    Extends: Core.Abstract
    Implements: [
      Interfaces.Children
    ...
    removeItem: (li) ->
      if @hasChild li
        ...
        @removeChild li
define "Iterable.ListItem","Iterable.MenuListItem", ->
  new Class
    ...
    create: ->
      ...
      @base.grab @sc
define "Core.Abstract","Iterable.ListItem", ->
  new Class
    Extends: Core.Abstract
    Attributes:
      label:
...
define ["Data.Abstract","Core.Slider"], "Data.Number", ->
  new Class
    Extends: Core.Slider
    Attributes:
      class:
...
define ["Data.Abstract","Data.Number","Data.Select","Interfaces.Children","Interfaces.Enabled","Interfaces.Size"], "Data.Unit", ->
  new Class
    ...
    ready: ->
      @set 'size', @size
define ["Core.Slot","Data.Abstract","Iterable.ListItem","Interfaces.Children","Interfaces.Enabled"],"Data.DateTime", ->
  new Class
    Extends:Data.Abstract
    Implements: [
      Interfaces.Children
...
define "Data.DateTime", "Data.Time", ->
  new Class 
    ...
    Attributes:
      ...
      date:
        value: no
define "Data.DateTime", "Data.Date", ->
  new Class
    Extends:Data.DateTime
    Attributes:
      class:
      ...
      time:
        value: no
define ["Data.Abstract","Data.Color","Interfaces.Children","Interfaces.Enabled","Interfaces.Size"], "Data.ColorWheel", ->
  new Class
    Extends: Data.Abstract
    Implements: [
      Interfaces.Children
    ...
    ready: ->
      @update()
define ["Data.Abstract","Data.Number","Buttons.Toggle","Groups.Toggles", "Interfaces.Children","Interfaces.Enabled","Interfaces.Size"], "Data.Color", ->
  new Class
    Extends:Data.Abstract
    Binds: ['update']
    Implements: [
...
define "Core.Abstract", "Data.Abstract", ->
  new Class
    Extends: Core.Abstract
    Attributes:
      value:
        value: null
define ["Interfaces.Controls","Interfaces.Children","Interfaces.Enabled", "Interfaces.Size","Core.Picker","Iterable.List","Data.Abstract","Dialog.Prompt"], "Data.Select", -> 
  new Class
    Extends: Data.Abstract
    Implements:[
      Interfaces.Controls
...
define "Data.Abstract", "Data.Table", ->
  new Class
    Extends: Data.Abstract
    Binds: ['update']
    Attributes:
    ...
    removeColumn: (where) ->
      ...
      @fireEvent 'change', @get 'value'
define ["Dialog.Abstract","Buttons.Abstract"], "Dialog.Alert", ->
  new Class
    ...
    create: ->
      ...
      @button.addEvent 'invoked', (el,e) =>
        @fireEvent 'invoked', [@,e]
        @hide(e,true)
define ["Dialog.Abstract","Buttons.Abstract","Data.Text"], "Dialog.Prompt", ->
  new Class
    Extends: Dialog.Abstract
    Attributes:
      class:
    ...
    create: ->
      ...
      @button.addEvent 'invoked', (el,e) =>
        ...
        @hide(e,true)
define ["Dialog.Abstract","Buttons.Abstract"], "Dialog.Confirm", ->
  new Class
    Extends: Dialog.Abstract
    Attributes:
      class:
    ...
    create: ->
      ...
      @cancelButton.addEvent 'invoked', (el,e) =>
        ...
        @hide(e,true)
define ["Core.Abstract","Buttons.Abstract"], "Dialog.Abstract", ->
  new Class
    Extends:Core.Abstract
...
define "Buttons.Abstract","Buttons.Key", ->
  new Class
    Extends: Buttons.Abstract
    Attributes:
      class:
...
define ["Core.Abstract","Interfaces.Enabled","Interfaces.Size"], "Core.Slot", ->
  new Class
    Extends: Core.Abstract
    Implements: [
      Interfaces.Enabled
...
define ["Core.Abstract","Interfaces.Enabled","Interfaces.Controls"], "Core.Slider", ->
  new Class
    Extends:Core.Abstract
    Implements:[
      Interfaces.Controls
  ...
  new Class
    ...
    create: ->
      @base.addEvent 'click', (e) =>
        if @enabled
          @fireEvent 'invoked', [@, e]
define ["Core.Abstract","Interfaces.Enabled","Interfaces.Controls"], "Core.Picker", ->
  new Class
    Extends: Core.Abstract
    Implements: [
      Interfaces.Children
        ...
        if force?
          ...
          if @base.isVisible() and not @base.hasChild(e.target)
            if @attachedTo?
              @attachedTo.removeClass @picking
            @base.dispose()
define ["Core.Abstract","Interfaces.Enabled","Interfaces.Controls","Interfaces.Size"], "Core.Toggler", ->
  new Class
    Extends: Core.Abstract
    Implements:[
      Interfaces.Enabled
  ...
  new Class 
    ...
    create: ->
      @base.setStyles 
        ...
        bottom:0
      @hide()
define ["Core.Abstract","Interfaces.Enabled","Interfaces.Size"],"Core.Checkbox", ->
  new Class 
    Extends: Core.Abstract
    Implements: [
      Interfaces.Enabled
    ...
    create: ->
      ...
      @base.addEvent 'click', =>
        if @enabled
          @set 'state', if @state then false else true
define ["Core.Abstract","Interfaces.Enabled"], "Core.Tip", ->
  new Class
    Extends:Core.Abstract
    Implements: Interfaces.Enabled
    Binds:[
...
define ["Lattice","Class.Mutators.Attributes","Interfaces.Mux"],"Core.Abstract", ->
  new Class 
    ...
    toElement: ->
      @base
define "Core.Slider", "Core.Scrollbar", ->
  new Class
    Extends: Core.Slider
    Attributes:
      mode:
